...
<html lang="ru">
  ...
  <body>
    ...
    <section id="advantages" class="advantages">
      ...
      <div class="advantages-list"> 
        <div class="item">
          ...
          <h3>От а до я</h3>
          <p>Полный спектор работ по монтажу каминов и печей. Выезд на змер — бонус.</p>
        </div>
        <div class="item">
        ...
        <div class="item">
          ...
          <h3>100% Гарантия</h3>
          <p>Гарантия один год, после-гарантийное обслуживание, лецензия МЧС.</p>
        </div>
      </div>
    </section>
    ...
    <div class="fireplaces-container">
      ...
      <div class="models-container">
        <div class="models-wrapper">
          <div class="model"><img src="img/fireplaces_items/bio/12.jpg" alt="Классические">
            <h3>Классические</h3>
            <p>Прекрасная имитация пламени с опцией обогрева.</p>
            <button class="modal-button">Заказать</button>
          </div>
          <div class="model"><img src="img/fireplaces_items/bio/13.jpg" alt="Современные">
            <h3>Современные</h3>
        ...
        <div class="swiper-container">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <p>Спасибо огромное, с вами приятно иметь дело. В будущем откроем заказ на настоящий камин  и, конечно, только у вас. Будет вдохновлять меня на творчество.</p><span>Ольга Кормухина</span><small>ГАвтор и исполнитель песен</small>
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
              ...
              <p>Выражаю искреннюю благодарность всем, кто создавал эту красоту. Рекомендую.</p><span>Ирченко Наталья</span><small>Бизнеследи</small>
            </div>
          </div>
        </div>
      </div>
